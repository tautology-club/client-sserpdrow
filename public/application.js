...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://pacific-lake-39293.herokuapp.com',
...
var pageEvents = __webpack_require__(15);
var blogEvents = __webpack_require__(36);
...
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  api.signOut().then(ui.signOutSuccess);
};
...
var onCreatePage = function onCreatePage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createPage(data).then(ui.createPageSuccess).then(function () {
    return onGetMyPages(event);
  }).catch(ui.createPageFailure);
};

var onGetPages = function onGetPages(event) {
  event.preventDefault();
  api.getPages().then(ui.getPagesSuccess).catch(ui.getPagesFailure);
};

var onShowPages = function onShowPages() {
  // event.preventDefault()
  api.showAllPages().then(ui.showPagesSuccess).catch(ui.showPagesFailure);
};

var onGetMyPages = function onGetMyPages(event) {
  event.preventDefault();
  api.getPages().then(ui.getMyPagesSuccess).catch(ui.getMyPagesFailure);
};

var onUpdatePages = function onUpdatePages(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var pageId = $(event.target).data('id');
  api.updatePages(data, pageId).then(ui.getUpdatePageSuccess(pageId)).then(function () {
    return onGetMyPages(event);
  }).catch(ui.getUpdatePageFailure);
};

var onDeletePage = function onDeletePage(event) {
  event.preventDefault();
  var pageId = $(event.target).closest('ul').attr('data-id');
  api.deletePage(pageId).then(ui.getDeletePageSuccess).then(function () {
    return onGetMyPages(event);
...
var showAllPages = function showAllPages() {
  return $.ajax({
    url: config.apiUrl + '/pages',
    method: 'GET',
    headers: {
...
var updatePages = function updatePages(data, pageId) {
  return $.ajax({
...
var showPagesTemplate = __webpack_require__(18);
var showMyPagesTemplate = __webpack_require__(35);
var store = __webpack_require__(2);

var createPageSuccess = function createPageSuccess() {
...
var createPageFailure = function createPageFailure() {
...
var getPagesSuccess = function getPagesSuccess(data) {
  var getPagesHTML = showPagesTemplate({ pages: data.pages });
...
var getPagesFailure = function getPagesFailure() {
  $('.status').text('Failed to retrieve pages. No pages were found.');
};

var showPagesSuccess = function showPagesSuccess(data) {
  var getPagesHTML = showPagesTemplate({ pages: data.pages });
  $('.public-page-content').html(getPagesHTML);
};

var showPagesFailure = function showPagesFailure() {
  $('.status').text('Failed to retrieve Pages. No pages were found.');
};

var getMyPagesSuccess = function getMyPagesSuccess(data) {
  var myPages = [];
  ...
  var getMyPagesHTML = showMyPagesTemplate({ pages: myPages });
...
var getMyPagesFailure = function getMyPagesFailure() {
  $('.status').text('Failed to retrieve pages. No pages were found.');
};

var getUpdatePageSuccess = function getUpdatePageSuccess(pageId) {
  $('.status').text('You have successfully updated a page!');
  setTimeout(function () {
    return $('.status').text('');
  }, 2000);
  var modalName = '#updateModal' + pageId;
  $(modalName).modal('toggle');
  $('input[type=text]').val('');
};

var getUpdatePageFailure = function getUpdatePageFailure() {
  $('.status').text('Failed to update page. Something has gone wrong.');
};

var getDeletePageSuccess = function getDeletePageSuccess() {
...
var getDeletePageFailure = function getDeletePageFailure() {
...
module.exports = {
  ...
  getPagesSuccess: getPagesSuccess,
  getPagesFailure: getPagesFailure,
  showPagesSuccess: showPagesSuccess,
  showPagesFailure: showPagesFailure,
  getMyPagesSuccess: getMyPagesSuccess,
  getMyPagesFailure: getMyPagesFailure,
  getUpdatePageSuccess: getUpdatePageSuccess,
  getUpdatePageFailure: getUpdatePageFailure,
  getDeletePageSuccess: getDeletePageSuccess,
  getDeletePageFailure: getDeletePageFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div>\n  <h1 data-id=\""
    ...
    + "\" class=\"my-page\"><small>Owner ID: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner : stack1), depth0))
    + "</small></h1>\n  <ul data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    Name: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.name : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  <br>\n    Text: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.text : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </ul>\n</div>\n<hr>\n";
  ...
  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.text : stack1), depth0))
    + "\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div>\n  <h1 data-id=\""
    ...
    + "<br>\n  Text: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.text : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  <br>\n    <input type=\"button\" class=\"btn classic\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n          <form class=\"update-page\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n            <p>Name: <input required type=\"text\" name=\"page[name]\" placeholder=\"New Name\"></p>\n            <textarea required type=\"text\" name=\"page[text]\" maxlength=\"2000\" cols=\"30\" rows=\"4\" placeholder=\"New Text Here\"></textarea>\n            <br>\n            <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"submit\" value=\"Update Page\">\n          </form>\n        </div>\n      <div class=\"modal-footer\">\n\n      </div>\n    </div>\n  </div>\n</div>\n<!--End of Update Modal   -->\n    <button type=\"button\" class=\"btn classic destroy-id\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
...
var onCreateBlog = function onCreateBlog(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createBlog(data).then(ui.createBlogSuccess).then(function () {
    return onGetMyBlogs(event);
  }).catch(ui.createBlogFailure);
};

var onShowBlogs = function onShowBlogs(event) {
  event.preventDefault();
  api.showAllBlogs().then(ui.showBlogsSuccess).then(clearContent).catch(ui.showBlogsFailure);
};

var onGetBlogs = function onGetBlogs(event) {
  if (event) {
    event.preventDefault();
  }
  api.getBlogs().then(ui.getBlogsSuccess).catch(ui.getBlogsFailure);
};

var onGetMyBlogs = function onGetMyBlogs(event) {
  event.preventDefault();
  api.getBlogs().then(ui.getMyBlogsSuccess).catch(ui.getMyBlogsFailure);
};

var onUpdateBlogs = function onUpdateBlogs(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var blogId = $(event.target).data('id');
  api.updateBlogs(data, blogId).then(ui.getUpdateBlogSuccess(blogId)).then(function () {
    return onGetMyBlogs(event);
  }).catch(ui.getUpdateBlogFailure);
};

var onDeleteBlog = function onDeleteBlog(event) {
  event.preventDefault();
  var blogId = $(event.target).closest('ul').attr('data-id');
  api.deleteBlog(blogId).then(ui.getDeleteBlogSuccess).then(function () {
    return onGetMyBlogs(event);
...
var createBlog = function createBlog(data) {
  data.user = store.user;
  return $.ajax({
...
var updateBlogs = function updateBlogs(data, blogId) {
  return $.ajax({
...
var showBlogsTemplate = __webpack_require__(39);
var showMyBlogsTemplate = __webpack_require__(40);
var store = __webpack_require__(2);

var createBlogSuccess = function createBlogSuccess() {
...
var createBlogFailure = function createBlogFailure() {
...
var getBlogsSuccess = function getBlogsSuccess(data) {
  var getBlogsHTML = showBlogsTemplate({ blogs: data.blogs });
...
var getBlogsFailure = function getBlogsFailure() {
  $('.status').text('Failed to retrieve blogs. No blogs were found.');
};

var showBlogsSuccess = function showBlogsSuccess(data) {
  var getBlogsHTML = showBlogsTemplate({ blogs: data.blogs });
  $('.public-blog-content').html(getBlogsHTML);
};

var showBlogsFailure = function showBlogsFailure() {
  $('.status').text('Failed to retrieve blogs. No blogs were found.');
};

var getMyBlogsSuccess = function getMyBlogsSuccess(data) {
  var myBlogs = [];
  ...
  var getMyBlogsHTML = showMyBlogsTemplate({ blogs: myBlogs });
...
var getMyBlogsFailure = function getMyBlogsFailure() {
  $('.status').text('Failed to retrieve blogs. No blogs were found.');
};

var getUpdateBlogSuccess = function getUpdateBlogSuccess(blogId) {
  $('.status').text('You have successfully updated a blog!');
  setTimeout(function () {
    return $('.status').text('');
  }, 2000);
  var modalName = '#updateModal' + blogId;
  $(modalName).modal('toggle');
  $('input[type=text]').val('');
};

var getUpdateBlogFailure = function getUpdateBlogFailure() {
  $('.status').text('Failed to update blog. Something has gone wrong.');
};

var getDeleteBlogSuccess = function getDeleteBlogSuccess() {
...
var getDeleteBlogFailure = function getDeleteBlogFailure() {
  $('.status').text('Failed to delete blog. Something has gone wrong.');
};

module.exports = {
  createBlogSuccess: createBlogSuccess,
  createBlogFailure: createBlogFailure,
  getBlogsSuccess: getBlogsSuccess,
  getBlogsFailure: getBlogsFailure,
  showBlogsSuccess: showBlogsSuccess,
  showBlogsFailure: showBlogsFailure,
  getMyBlogsSuccess: getMyBlogsSuccess,
  getMyBlogsFailure: getMyBlogsFailure,
  getUpdateBlogSuccess: getUpdateBlogSuccess,
  getUpdateBlogFailure: getUpdateBlogFailure,
  getDeleteBlogSuccess: getDeleteBlogSuccess,
  getDeleteBlogFailure: getDeleteBlogFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div>\n  <h1 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"my-blog\"> <small>Owner ID: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner : stack1), depth0))
    + "</small></h1>\n  <ul data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n    Name: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.title : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "<br>\n\n  Text: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.body : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </ul>\n</div>\n<hr>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.title : stack1), depth0))
    + "\n";
},"4":function(container,depth0,helpers,partials,data) {
  ...
  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.body : stack1), depth0))
    + "\n";
},"8":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.blogs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div>\n  <h1 data-id=\""
    ...
    + "\" data-toggle=\"modal\" data-target=\"#updateModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"Update\" class=\"update-id\" value=\"Update\">\n\n    <!--Begin Update Modal -->\n    <div class=\"modal blogUpdateModal\" id=\"updateModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\"  tabindex=\"-1\" role=\"dialog\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n            <h4 class=\"modal-title\">Update Blog Post</h4>\n          </div>\n        <div class=\"modal-body\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n          <form class=\"update-blog\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n            <p>Name: <input required type=\"text\" name=\"blog[title]\" placeholder=\"New Name\"></p>\n            <textarea required type=\"text\" name=\"blog[body]\" maxlength=\"2000\" cols=\"30\" rows=\"4\" placeholder=\"New Text Here\"></textarea>\n            <br>\n            <input type=\"hidden\" name=\"blog[id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n            <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"submit\" value=\"Update Blog\">\n          </form>\n        </div>\n      <div class=\"modal-footer\">\n\n      </div>\n    </div>\n  </div>\n</div>\n<!--End of Update Modal   -->\n    <button type=\"button\" class=\"btn classic destroy-id\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"Remove\">Remove</button>\n</ul>\n</div>\n<hr>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
